...
TRAIN_DATA_DIR = Path('/mnt/d/med_data/biron/data2/train_new')  # 训练集
TEST_DATA_DIR = Path('/mnt/d/med_data/biron/data2/test_new')  # 验证集 + 测试集
...
class Trainer:
    def __init__(self, model, train_loader, val_loader, test_loader,
        ...
        self.criterion = DiceFocalLoss(weight_dice=1.5, weight_focal=0.6)
