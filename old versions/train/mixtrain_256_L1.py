...
class CombinedLoss(nn.Module):
    ...
    def forward(self, pred, target):
        ...
        return total_loss, {'dice_loss': dice_loss, 'l1_loss': l1_loss}
...
def compute_metrics(pred, target, threshold=0.5):
    ...
    metrics = {
        ...
        'l1': float(np.mean(l1_list))  # 添加 L1 损失
    }
...
def save_test_results(test_metrics, save_dir):
    ...
    print(f"L1 Loss: {test_metrics['l1']:.4f}")  # 添加 L1 损失打印
    print(f"{'=' * 50}")
