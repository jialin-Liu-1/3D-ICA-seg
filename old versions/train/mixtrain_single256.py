...
DATA_DIR = Path('/mnt/d/med_data/biron/data1/train_90')
...
def preprocess_and_cache(data_dir, cache_root, img_size=256, train_ratio=0.8, seed=42):
...
class Trainer:
    def __init__(self, model, train_loader, val_loader, test_loader,
        ...
        self.criterion = CombinedLoss(weight_dice=1.0, weight_bce=0.5)

        # ========== 修改2: 添加GradScaler用于混合精度训练 ==========
