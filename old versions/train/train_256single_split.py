...
TRAIN_DATA_DIR = Path('/mnt/d/med_data/biron/data1/train2')  # 训练集
TEST_DATA_DIR = Path('/mnt/d/med_data/biron/data1/test1')  # 验证集 + 测试集
...
# ============================================================
# 6. 训练器（混合精度版本 + 累计不改进触发学习率衰减）
# ============================================================
# ============================================================
# 6. 训练器（混合精度版本 + 分离的早停和学习率衰减策略）
# ============================================================
# ============================================================
# 6. 训练器（混合精度版本 + 分离的早停和余弦退火学习率衰减）
# ============================================================
class Trainer:
    def __init__(self, model, train_loader, val_loader, test_loader,
        ...
        self.criterion = CombinedLoss(weight_dice=1.0, weight_bce=0.7)
