...
class X2Shape(nn.Module):
    def __init__(self, img_size=128, in_chans=1, num_classes=2,
        ...
        self.cross_mambas = nn.ModuleList([
            CrossMamba(256),  # 最深尺度 (8³)
            CrossMamba(128),  # 中间尺度 (16³)
    ...
    def forward(self, x_ap, x_lat):
        # Step 1: 2D 编码
        f_ap_2d = self.encoder_2d_ap(x_ap)  # [64@64², 128@32², 256@16²]
        ...
        # Step 3: 3D Encoder
        f_ap_3d_multi = self.encoder_3d_ap(f_ap_3d_base)  # [256@8³, 128@16³, 64@32³]
        ...
        # Step 5: U-Net 升采样路径
        current_feat = cross_outputs[0]  # (256, 8³)
